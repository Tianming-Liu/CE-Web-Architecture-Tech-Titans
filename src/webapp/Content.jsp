...
<div class="container1">
    <div style="width:12%;text-align:left;margin-left:30px;margin-right:30px;">
        ...
        <ul class="nav nav-pills nav-stacked">
            ...
            <br>
            <li class="active"><a href="${basePath}/content/list">Crime Information</a></li>
            <br>
    ...
    <div style="width:88%;text-align: left;margin-left:20px;margin-right:30px;">
            ...
            <nav class="navbar navbar-default" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#">Hotel & Crime Map</a>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    <span class="input-group-addon">Crime</span>
                    <input type="text" class="form-control" placeholder="" id="classification" style="width: 200px;">
                </div>
            </div>
            <div class="col-md-3">
...
<script type="text/javascript">
    ...
    function list(jsonParam) {
        $.ajax({
            url: '${basePath}/rest/content/list',//地址
            dataType: 'json',//数据类型
            type: 'POST',//类型
            timeout: 5000,//超时
            data: jsonParam,
    ...
    function initList(data) {
        ...
        $.each(data, function (n, value) {
            var choice = '<tr><td>' + value.code + '</td><td>' + value.street + '</td><td>' + value.name + '</td>'
                + '<td>' + value.classification + '</td><td>' + value.amount + '</td></tr>'
            choices += choice;
        });
    ...
    function edit_obj(obj) {
        ...
        window.location.href = "${basePath}/content/edit?uid=" + uid;
    }
    ...
    function delete_obj(obj) {
        ...
        let jsonParam = JSON.stringify(param);
        $.ajax({
            url: '${basePath}/rest/content/delete',//地址
            dataType: 'json',//数据类型
            type: 'POST',//类型
            timeout: 5000,//超时
            data: jsonParam,
    ...
    function copy_obj(obj) {
        ...
        let jsonParam = JSON.stringify(param);
        $.ajax({
            url: '${basePath}/rest/content/copy',//地址
            dataType: 'json',//数据类型
            type: 'POST',//类型
            timeout: 5000,//超时
            data: jsonParam,
