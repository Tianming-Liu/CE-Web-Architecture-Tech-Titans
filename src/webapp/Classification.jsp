...
<div class="container1">
    <div style="width:12%;text-align:left;margin-left:30px;margin-right:30px;">
        ...
        <ul class="nav nav-pills nav-stacked">
            ...
            <br>
            <li class="active"><a href="${basePath}/classification/list">Crime Classification</a></li>
            <br>
            <li><a href="${basePath}/content/list">Crime Information</a></li>
            <br>
...
<script type="text/javascript">
    ...
    function list(jsonParam) {
        $.ajax({
            url: '${basePath}/rest/classification/list',//地址
            dataType: 'json',//数据类型
            type: 'POST',//类型
            timeout: 5000,//超时
            data: jsonParam,
    ...
    function initList(data) {
        ...
        $.each(data, function (n, value) {
            var choice = '<tr><td>' + value.number + '</td><td>' + value.name + '</td></tr>';
            choices += choice;
        });
    ...
    function edit_obj(obj) {
        ...
        window.location.href = "${basePath}/classification/edit?uid=" + uid;
    }
    ...
    function delete_obj(obj) {
        ...
        let jsonParam = JSON.stringify(param);
        $.ajax({
            url: '${basePath}/rest/classification/delete',//地址
            dataType: 'json',//数据类型
            type: 'POST',//类型
            timeout: 5000,//超时
            data: jsonParam,
